const myRules = [
  ...
  "DOMAIN-SUFFIX,api2.cursor.sh:443,ChatGPT",
  ...
  "DOMAIN-SUFFIX,fastlink.cc,节点选择",
  "DOMAIN-SUFFIX,githubcopilot.com,ChatGPT",
  "DOMAIN-SUFFIX,useblackbox.io,ChatGPT",
  "PROCESS-NAME,Cursor.exe,ChatGPT",
  "PROCESS-NAME,Windsurf.exe,ChatGPT",
  // 自定义规则
...
function main(config) {
  ...
  config["rules"] = myRules.concat(rules);
